...
import { ANALYTICS_EVENTS, BOOKING } from "@/lib/content/site-config";
import { STUDIO_PRICING, usd } from "@/lib/content/pricing-data";

/**
 * 3-card pricing block (Hourly / Half-day / Full-day) used on /studio-pricing
 * and embedded marketing pages.
 *
 * 2026-05-30 cutover: each card's CTA now navigates to /book-studio
 * instead of opening the Acuity iframe modal. No client-side state needed
 * anymore, so the component is now a server component.
 */
        ...
        >
          ...
          <div className="mt-6">
            <Button
              ...
              tracking={{
                type: "book_studio",
                event: ANALYTICS_EVENTS.clickBookStudio,
                page,
                location: `pricing-${t.id}`,
              }}
            >
